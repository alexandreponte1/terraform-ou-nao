...
senha, estado = read_pubsub()

print(senha)
print(estado)


# {"name":"projects/24924894323/secrets/alexandrepontek1/versions/1","createTime":"2022-09-15T17:53:00.341002Z","state":"ENABLED","replicationStatus":{"userManaged":{"replicas":[{"location":"us-central1"}]}},"etag":"\"15e7b5669eeb0a\"","clientSpecifiedPayloadChecksum":true}
